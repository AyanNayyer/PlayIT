...
export default {
    ...
    <div class="container mt-3">
        ...
        <div v-if="search_results !== null" class="mt-4">
        ...
        <!-- Filter and Recommended Songs Section -->
        <div class="row justify-content-center mt-4">
            <div class="col-md-5">
                <b><h1><u>Recommendations</u></h1></b>
            </div>
            <div class="col-md-5 text-end ms-auto">
                <form class="d-flex">
                    <label for="filter_type"><h4>Filter by: </h4></label>
        ...
        <div class="row justify-content-center mt-4">
            <div v-for="song in filtered_songs" :key="song.id" class="col-md-4 mb-3">
                <div class="card" style="background-color: lightyellow;">
                    <div class="card-body">
                        <h5 class="card-title"><b><span style="color: green;">{{ song.name }}</span></b></h5>
                        <p class="card-text"><b>Artist</b>: {{ song.creator_name }}</p>
                        <p class="card-text"><b>Likes:</b> {{ song.likes }}</p>
                        <p class="card-text"><b>Views</b>: {{ song.play_count }}</p>
