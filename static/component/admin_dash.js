export default {
    template: `
        <div>
            <div class="search-bar" style="display: flex; justify-content: flex-end; padding: 5px;">
                <form class="d-flex">
            ...
            <div class="container performance-container" style="margin-top: 5px; text-align: center;">
                <h2><b>App's Performance</b></h2>
                <div class="row">
                    <div class="col-4">
